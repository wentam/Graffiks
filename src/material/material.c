...
material* create_material() {
    GLuint vertex_shader_ref = _create_shader("/shaders/material.vert", GL_VERTEX_SHADER);
    GLuint fragment_shader_ref = _create_shader("/shaders/material.frag", GL_FRAGMENT_SHADER);
